        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold text-gray-900 dark:text-white">AJ Softdrive</span>
            </div>
      ...
      <main className="flex-grow flex items-center justify-center">
        <div className="max-w-md w-full space-y-8 p-8 bg-white dark:bg-gray-800 rounded-xl shadow-md">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">AJ Softdrive POS</h1>
            <p className="mt-2 text-gray-600 dark:text-gray-300">Point of Sale System</p>
          </div>
          ...
          {session ? (
            ...
            <>
              <div className="text-center">
                <p className="text-gray-600 dark:text-gray-300">Please select your login option:</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 text-base font-medium rounded-md shadow-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                >
                  Cashier Login
                </a>
              </div>
